...
/*--------------------------------------------------------------------------*/
	...
	static readonly bool[,] set = {
		...
		{x,T,x,x, x,x,x,x, x,x,x,x, T,T,x,x, x,x,x,T, x,T,T,T, x,T,T,x, x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,T,T,T, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,T,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,x,x}
